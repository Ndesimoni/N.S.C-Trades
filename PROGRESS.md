...
**Five crates · 385 tests · 24 against a real database · 10 against a real database · clippy clean · it watches his levels, says what
...
- [ ] **No fallback feed.** Twelve Data went on 20 August. TWS not logged in
      ...
      a week
- [ ] **Only the candles are stored**, though those now keep themselves up to
      date. A restart still forgets every zone it was sitting in, and nothing
      answers "why did nothing fire last week?" — that needs `runs` and
      `rejections`
